...
class Graph():
  ...
  def get_edge(self):
    ...
    neighbor_base = [(0, 1), (1, 2), (2, 3), (2, 4), (4, 5), (5, 6), (2, 7), (7, 8),
...
from model.custom.net.utils.tgcn import ConvTemporalGraphical
...
if __name__ == "__main__":
    summary(model, torch.rand((1, 3, 150,16,1)).to(device))